...
def add_ring(df, name, x0,y0,outside_radius = 10, inside_radius = 0,
             keep_distance = False, 
    ...
    _condition = (df_c['state'] == "unclassified") & (df_c['_distance'] < outside_radius) & (df_c['_distance'] > inside_radius)
