        ...
        for t in range(num_frames - 1):
            if distance_to_next_pos[f][t] is not None:
                ...
                if np.isfinite(x_new) and np.isfinite(y_new):
                    ...
                    distance_to_next_pos[f][t]["scored_raw_distance_to_next_pos"] = 1 - (distance_to_next_pos[f][t]["raw_distance_to_next_pos"]/(2*window_size))**2
                    distance_to_next_pos[f][t]["rescaled_scored_raw_distance_to_next_pos"] = (distance_to_next_pos[f][t]["scored_raw_distance_to_next_pos"] - distance_to_next_pos[f][t]["scored_raw_distance_to_next_pos"].min())/(distance_to_next_pos[f][t]["scored_raw_distance_to_next_pos"].max() - distance_to_next_pos[f][t]["scored_raw_distance_to_next_pos"].min())
                    distance_to_next_pos[f][t]["rescaled_distance_to_next_pos"] = (distance_to_next_pos[f][t]["raw_distance_to_next_pos"] - distance_to_next_pos[f][t]["raw_distance_to_next_pos"].min())/(distance_to_next_pos[f][t]["raw_distance_to_next_pos"].max() - distance_to_next_pos[f][t]["raw_distance_to_next_pos"].min())
                    distance_to_next_pos[f][t]["scored_rescaled_distance_to_next_pos"] = 1 - distance_to_next_pos[f][t]["rescaled_distance_to_next_pos"]
                else:
                    distance_to_next_pos[f][t]["raw_distance_to_next_pos"] = np.nan
                    distance_to_next_pos[f][t]["scored_raw_distance_to_next_pos"] = np.nan
                    distance_to_next_pos[f][t]["rescaled_scored_raw_distance_to_next_pos"] = np.nan
                    distance_to_next_pos[f][t]["rescaled_distance_to_next_pos"] = np.nan
                    distance_to_next_pos[f][t]["scored_rescaled_distance_to_next_pos"] = np.nan

        #save nans for last frame
        distance_to_next_pos[f][num_frames-1]["raw_distance_to_next_pos"] = np.nan
        distance_to_next_pos[f][num_frames-1]["scored_raw_distance_to_next_pos"] = np.nan
        distance_to_next_pos[f][num_frames-1]["rescaled_scored_raw_distance_to_next_pos"] = np.nan
        distance_to_next_pos[f][num_frames-1]["rescaled_distance_to_next_pos"] = np.nan
        distance_to_next_pos[f][num_frames-1]["scored_rescaled_distance_to_next_pos"] = np.nan
...
def generate_distance_to_next_pos(foragers_object : dataObject):
    ...
    return _generate_distance_to_next_pos(foragers_object.foragers, foragers_object.local_windows, window_size)
